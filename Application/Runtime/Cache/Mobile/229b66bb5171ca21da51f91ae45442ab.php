            ...
            <div class="content">
                <div class="list-block">
                 ...
                 <div class="content-block">
                    <div class="row">
                      <div class="col-100"><a href="#" class="button button-big button-fill button-success">登录</a></div>
                      <div class="col-100" style="text-align: center;line-height: 3rem;">
                          <a href="<?php echo U('reg');?>" style="margin-right: .3rem;">注册账号</a>|<a href="" style="margin-left: .3rem;">忘记密码</a>
                      </div>
                    </div>
                  </div>
            </div>
